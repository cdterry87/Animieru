                ...
                <v-layout align-center justify-center>
                    <v-flex xs12 sm10 md5>
                        <v-card class="elevation-3">
                            <v-card-text>
                                <h3 class="title text-xs-center mb-3">Register</h3>
                                <div class="mt-3 mb-3 text-xs-center">
                                    Sign up to keep track of your favorite anime and share with your friends!
                                </div>
                                <v-text-field prepend-icon="person" id="login" name="login" label="Name" type="text"></v-text-field>
